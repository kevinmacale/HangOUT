...
{
    /// <summary>
    /// A base attached property to replace the vanilla wpf's
    /// </summary>
    /// <typeparam name="Parent">The parent class to be the attached prperty</typeparam>
    /// <typeparam name="Property">The type of this attached prperty</typeparam>
    public abstract class BaseAttachedProperty<Parent, Property>
        where Parent : new()
    {
        #region Public Event
        /// <summary>
        /// Fire whern the value changes
        /// </summary>
        ...
        #region Attached Propert Definitions
        /// <summary>
        /// The attached property for this class
        /// </summary>
        public static readonly DependencyProperty ValueProperty = DependencyProperty.RegisterAttached("Value", typeof(Property),
            typeof(BaseAttachedProperty<Parent, Property>), new UIPropertyMetadata(default(Property), new PropertyChangedCallback(OnValuePropertyChanged)
